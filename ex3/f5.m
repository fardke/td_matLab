...
%print -deps "/home/kewin/octave/td_matLab/rapport/fig/resEx3/f5Gain.eps" 

input ('Figure suivante ?') ;
%Diagramme de phase
plot(nu,angle(H)) ;
my_title('Diagramme de phase en frequence reduite',25) ;
%print -deps "/home/kewin/octave/td_matLab/rapport/fig/resEx3/f5Phase.eps" 

input ('Figure suivante ? ') ;
%Zeros et poles
zplane(B, A) ;
my_title('Zeros et poles',25) ;
%print -deps "/home/kewin/octave/td_matLab/rapport/fig/resEx3/f5ZP.eps"
...
%print -deps "/home/kewin/octave/td_matLab/rapport/fig/resEx3/f5Impulsion.eps" 
...
%print -deps "/home/kewin/octave/td_matLab/rapport/fig/resEx3/f5Indice.eps" 
