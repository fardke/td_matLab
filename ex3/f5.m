...
%print -deps "/home/kewin/octave/td_matLab/rapport/src/resEx3/f5Gain.jpg" 

input ('Figure suivante ?') ;
%Diagramme de phase
plot(nu,angle(H)) ;
my_title('Diagramme de phase en frequence reduite',25) ;
%print -deps "/home/kewin/octave/td_matLab/rapport/src/resEx3/f5Phase.jpg" 

input ('Figure suivante ? ') ;
%Zeros et poles
zplane(B, A) ;
my_title('Zeros et poles',25) ;
%print -deps "/home/kewin/octave/td_matLab/rapport/src/resEx3/f5ZP.jpg" 
...
%print -deps "/home/kewin/octave/td_matLab/rapport/src/resEx3/f5Impulsion.jpg" 
...
%print -deps "/home/kewin/octave/td_matLab/rapport/src/resEx3/f5Indice.jpg" 
