...
\section{Exercice 5}
\lstinputlisting[caption={Code source pour l'exercice 5}, label=lst:label, language=Octave]{src/ex5.m}

\section{Exercice 6}
\lstinputlisting[caption={Code source pour l'exercice 6}, label=lst:label, language=Octave]{src/ex6.m}

\section{Exercice 7}
\lstinputlisting[caption={Code source pour l'exercice 7}, label=lst:label, language=Octave]{src/ex7.m}
